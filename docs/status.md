...
The former standalone Janus, Mencius, SNOW/RO6, Extern-C, 2PL, and Rule protocol
...
its storage and query machinery. Generic Jetpack recovery code remains as a
legacy subsystem pending a separate audit; it is not a supported replacement
for the retired Rule protocol.
