...
- Current state (Phase 8.1e leaf 5): `RequestVote()` election fan-out,
...
- Remaining phase (8.1e): handle the remaining documented non-facaded
  `rpc_par_proxies_` access boundary and delete the transitional vote helper.
