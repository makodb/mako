...
- [ ] **Phase 3 — RPC framework boundary**. Decomposed into:
  ...
  - [ ] **Phase 3f — `MarshallDeputy` internals on `SerializableProxy`**. Replace `sp_data_` + `inner_sp_data_` duplication with a single `SerializableProxy serializable_`. Public surface unchanged.
