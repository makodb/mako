...
This document provides a complete API reference for the RPC reliability features in the srpc/rpc module.
...
**Header:** `src/srpc/rpc/connection_state.hpp`
...
**Module:** `srpc.reconnect_policy` (canonical Rust source:
`src/srpc/src/reconnect_policy.rs`)
...
**Module:** `srpc.circuit_breaker` (canonical Rust source:
`src/srpc/src/circuit_breaker.rs`)
...
**Header:** `src/srpc/rpc/request_queue.hpp`
...
**Module:** `srpc.request_options` (canonical source:
`src/srpc/src/request_options.rs`; C++ interface generated by rusty-cpp)
...
**Header:** `src/srpc/rpc/heartbeat.hpp`
...
**Header:** `src/srpc/rpc/connection_metrics.hpp`
...
**Header:** `src/srpc/rpc/errors.hpp`
...
**Header:** `src/srpc/rpc/callbacks.hpp`
...
**Header:** `src/srpc/rpc/client.hpp`
...
**Header:** `src/srpc/rpc/server.hpp`
