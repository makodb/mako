...
- `./docker_build.sh compose-down` now distinguishes full vs partial shutdown: if stale same-checkout compose projects are still running, it reports that only the current compose project was stopped.
