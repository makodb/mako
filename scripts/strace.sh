...
#strace -f -c -w ./build/deptran_server -f config/3c1s3r1p.yml -f config/concurrent_100.yml -f config/occ_paxos.yml -f config/tpca_fixed.yml -d 60 -P localhost &> tmp2.txt
