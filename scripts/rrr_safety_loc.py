#!/usr/bin/env python3
"""Tally @safe vs @unsafe vs unannotated LOC across rrr borrow-checked modules.
...
Usage: `python3 scripts/rrr_safety_loc.py` from the worktree root.
"""
import re
...
FILES = [
    "src/rrr/base/basetypes.cpp", "src/rrr/base/callback_wrapper.cpp",
    "src/rrr/base/debugging.cpp", "src/rrr/base/logging.cpp",
    "src/rrr/base/misc.cpp", "src/rrr/base/strop.cpp",
    "src/rrr/base/threading.cpp", "src/rrr/base/unittest.cpp",
    "src/rrr/misc/alarm.cpp", "src/rrr/misc/alock.cpp",
    "src/rrr/misc/any_message.cpp", "src/rrr/misc/cpuinfo.cpp",
    "src/rrr/misc/dball.cpp", "src/rrr/misc/marshal.cpp",
    "src/rrr/misc/netinfo.cpp", "src/rrr/misc/rand.cpp",
    ...
    "src/rrr/rpc/completion_tracker.cpp", "src/rrr/rpc/connection_metrics.cpp",
    "src/rrr/rpc/connection_state.cpp", "src/rrr/rpc/errors.cpp",
    "src/rrr/rpc/fiber_channel.cpp", "src/rrr/rpc/frame_codec.cpp",
    "src/rrr/rpc/heartbeat.cpp", "src/rrr/rpc/idempotency.cpp",
    "src/rrr/rpc/inmemory_channel.cpp", "src/rrr/rpc/internal_protocol.cpp",
    "src/rrr/rpc/load_balancer.cpp", "src/rrr/rpc/pollable_proxy.cpp",
    "src/rrr/rpc/reconnect_policy.cpp", "src/rrr/rpc/request_options.cpp",
