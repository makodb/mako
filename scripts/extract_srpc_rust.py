...
# `src/srpc` is a vendored copy of the standalone srpc repository, which is
...
# will let `src/srpc` become a submodule without touching either file.
#
...
# the vendored tree.
CRATE_ROOT = PurePosixPath("src/srpc")
