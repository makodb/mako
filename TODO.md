...
- [ ] Mako, build a high-performance, reliable, transactional, datastore; GA release
  - repeated task
    ...
    - [ ] for every day, check the commits in the last 48 hours if they introdued any rusty-unsafe functions or blocks. If found any, please fix them, only use rusty safe coding. [last done: 2026-03-16, 17:45 - 2 commits in 48h window (cd4b90ee, cc8205c6). cc8205c6: adds std::vector<std::string> encoded_vals in makoCon.cc with @safe annotation; no unique_ptr/shared_ptr/weak_ptr, no raw new/delete, no .detach(). examples/ not borrow-checked. CLEAN.]
