...
OUT_FILE="${CLIENT_TEST_RESULTS:-${ROOT_DIR}/tools/redis_compat/client_test_results.csv}"
LOG_DIR="${CLIENT_TEST_LOG_DIR:-${ROOT_DIR}/tools/redis_compat/client_logs}"
...
run_pytest() {
    ...
    run_checked "pytest" bash -lc "cd '${ROOT_DIR}' && MAKO_REDIS_HOST='${MAKO_HOST}' MAKO_REDIS_PORT='${MAKO_PORT}' python3 -m pytest tools/redis_compat -q --ignore=tools/redis_compat/_client_tmp"
}
...
run_node_clients() {
    ...
    local dir="${ROOT_DIR}/tools/redis_compat/_client_tmp/node"
...
run_jedis() {
    ...
    local dir="${ROOT_DIR}/tools/redis_compat/_client_tmp/jedis"
...
run_redis_rs() {
    ...
    local dir="${ROOT_DIR}/tools/redis_compat/_client_tmp/redis-rs"
...
run_fakeredis_py() {
    ...
    local dir="${ROOT_DIR}/tools/redis_compat/_client_tmp/fakeredis-py"
    local repo="${dir}/src"
    local deps="${dir}/deps"
