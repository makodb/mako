...
def run_mako_bank_transfer() -> str:
    ...
    result = run_shell(["python3", "third-party/redis/compat/run_bank_transfer.py"], env=env)
...
def main() -> None:
    if os.environ.get("G2_DEMO_ASSUME_REDIS_CLUSTER") != "1":
        cluster_script = ROOT_DIR / "third-party" / "redis" / "compat" / "fixtures" / "redis_cluster.sh"
