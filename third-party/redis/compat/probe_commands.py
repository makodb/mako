...
TIERS_FILE = ROOT / "third-party/redis/compat/command_tiers.json"
OUT_FILE = Path(os.environ.get("REDIS_COMPAT_PROBE_OUT", ROOT / "third-party/redis/compat/probe_results.json"))
