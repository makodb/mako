...
run_soak_guard() {
    ...
    run_optional_script "Soak guard" "third-party/redis/compat/run_soak.sh" bash third-party/redis/compat/run_soak.sh
}
...
run_resp_fuzz_guard() {
    ...
    run_optional_script "RESP fuzz guard" "third-party/redis/compat/run_fuzz.sh" bash third-party/redis/compat/run_fuzz.sh
}
