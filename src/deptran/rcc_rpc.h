...
public:
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcBulkPrepareRequest& o) {
        ar >> o.cmd;
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcBulkPrepareResponse& o) {
        ar >> o.ballot;
        ar >> o.val;
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcBulkPrepare2Request& o) {
        ar >> o.cmd;
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcBulkPrepare2Response& o) {
        ar >> o.ballot;
        ar >> o.val;
        ar >> o.ret;
        return ar;
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcSyncNoOpsRequest& o) {
        ar >> o.cmd;
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcSyncNoOpsResponse& o) {
        ar >> o.ballot;
        ar >> o.val;
        return ar;
    }
    ...
    enum {
        ...
        ACCEPT = 0x140e9911,
        DECIDE = 0x4fbcfca0,
        HEARTBEAT = 0x1e8b9537,
        FORWARDTOLEARNERSERVER = 0x37d2f953,
        BULKPREPARE = 0x5c0d75b6,
        BULKACCEPT = 0x46242176,
        BULKPREPARE2 = 0x266b332a,
        SYNCLOG = 0x56c09359,
        SYNCCOMMIT = 0x35baef0a,
        SYNCNOOPS = 0x60221a53,
        BULKDECIDE = 0x11ea45b3,
    };
...
public:
    ...
    enum {
        HEARTBEAT = 0x5f0be14c,
        FORWARD = 0x50c5cdb4,
        VOTE = 0x18ffa30a,
        VOTE2FPGA = 0x52343ebb,
        APPENDENTRIES = 0x522cc0aa,
        APPENDENTRIES2 = 0x41c8f62a,
        DECIDE = 0x1c1307ac,
    };
    // Registers RPC IDs with server using service index
    // @unsafe - calls rrr::Server::reg_rpc / unreg (not borrow-checked)
...
public:
    ...
    enum {
        VOTE = 0x20755676,
        VOTEDURABLE = 0x29426b27,
        APPENDENTRIES = 0x4df01b48,
        EMPTYAPPENDENTRIES = 0x23e4f644,
        APPENDENTRIESDURABLE = 0x194969a7,
        TIMEOUTNOW = 0x6be8294d,
        NOTIFYRESTART = 0x1a2040d7,
        INSTALLSNAPSHOT = 0x442a1a33,
        ADDSERVER = 0x42a70c01,
        REMOVESERVER = 0x3b645d90,
    };
    // Registers RPC IDs with server using service index
    // @unsafe - calls rrr::Server::reg_rpc / unreg (not borrow-checked)
    int __reg_to__(rrr::Server& svr, size_t svc_index) {
...
public:
    ...
    enum {
        MSGSTRING = 0x2d35eb44,
        MSGMARSHALL = 0x66dd1a19,
        REELECT = 0x1b3e5e9c,
        RULESPECULATIVEEXECUTE = 0x344ae751,
        DISPATCH = 0x3159350b,
        PREPARE = 0x4c8ee6a6,
        COMMIT = 0x21872eff,
        ABORT = 0x370ac909,
        EARLYABORT = 0x68808397,
        UPGRADEEPOCH = 0x65426a4e,
        TRUNCATEEPOCH = 0x288aaede,
        ISLEADER = 0x5967a9b3,
        ISFPGALEADER = 0x29c89916,
        SIMPLECMD = 0x5712870a,
        FAILOVERPAUSESOCKETOUT = 0x253cf289,
        FAILOVERRESUMESOCKETOUT = 0x453da7a4,
        RPC_NULL = 0x5fe9b9df,
        TAPIRACCEPT = 0x2eda0a07,
        TAPIRFASTACCEPT = 0x27fd8c8b,
        TAPIRDECIDE = 0x26409a2a,
        RCCDISPATCH = 0x4d08edd7,
        RCCFINISH = 0x1670c488,
        RCCINQUIRE = 0x1005ae8a,
        RCCDISPATCHRO = 0x5af14ed5,
        RCCINQUIREVALIDATION = 0x6c58048c,
        RCCNOTIFYGLOBALVALIDATION = 0x52ffb57f,
        JANUSDISPATCH = 0x212dfeb8,
        RCCCOMMIT = 0x3e821ba0,
        JANUSCOMMIT = 0x3cca6d6e,
        JANUSCOMMITWOGRAPH = 0x6a18d238,
        JANUSINQUIRE = 0x341c9904,
        RCCPREACCEPT = 0x15927851,
        JANUSPREACCEPT = 0x4515a224,
        JANUSPREACCEPTWOGRAPH = 0x3d42df8c,
        RCCACCEPT = 0x5a67c109,
        JANUSACCEPT = 0x223c28dd,
        JETPACKBEGINRECOVERY = 0x54e25e73,
        JETPACKPULLIDSET = 0x1d18df28,
        JETPACKPULLCMD = 0x6ffc0b43,
        JETPACKRECORDCMD = 0x24707eb9,
        JETPACKPREPARE = 0x66dfd5d5,
        JETPACKACCEPT = 0x27b4bd34,
        JETPACKCOMMIT = 0x2ba32667,
        JETPACKPULLRECSETINS = 0x5dd05010,
        JETPACKFINISHRECOVERY = 0x373ef1a8,
    };
    // Registers RPC IDs with server using service index
    // @unsafe - calls rrr::Server::reg_rpc / unreg (not borrow-checked)
    int __reg_to__(rrr::Server& svr, size_t svc_index) {
...
public:
    ...
    enum {
        SERVER_SHUTDOWN = 0x638f24b0,
        SERVER_READY = 0x4c0f61f0,
        SERVER_HEART_BEAT_WITH_DATA = 0x3989f168,
        SERVER_HEART_BEAT = 0x68fb5a30,
    };
    // Registers RPC IDs with server using service index
    // @unsafe - calls rrr::Server::reg_rpc / unreg (not borrow-checked)
    int __reg_to__(rrr::Server& svr, size_t svc_index) {
...
public:
    ...
    enum {
        CLIENT_GET_TXN_NAMES = 0x26475fd6,
        CLIENT_SHUTDOWN = 0x39a472f8,
        CLIENT_FORCE_STOP = 0x2717b42e,
        CLIENT_RESPONSE = 0x6e7c6e71,
        CLIENT_READY = 0x1743de0d,
        CLIENT_READY_BLOCK = 0x2426e092,
        CLIENT_START = 0x6665f28c,
        DISPATCHTXN = 0x62dd650b,
    };
    // Registers RPC IDs with server using service index
    // @unsafe - calls rrr::Server::reg_rpc / unreg (not borrow-checked)
    int __reg_to__(rrr::Server& svr, size_t svc_index) {
...
public:
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcGetConfigRequest& o) {
        ar >> o.client_version;
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcGetConfigResponse& o) {
        ar >> o.current_version;
        ar >> o.has_update;
        ar >> o.config_data;
        return ar;
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcGetConfigVersionRequest& o) {
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcGetConfigVersionResponse& o) {
        ar >> o.version;
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcHasConfigRequest& o) {
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcHasConfigResponse& o) {
        ar >> o.has_config;
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcSetShardingPolicyRequest& o) {
        ar >> o.policy_data;
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcSetShardingPolicyResponse& o) {
        ar >> o.success;
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcGetShardingPolicyRequest& o) {
        ar >> o.client_version;
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcGetShardingPolicyResponse& o) {
        ar >> o.current_version;
        ar >> o.has_update;
        ar >> o.policy_data;
        return ar;
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcGetShardingPolicyVersionRequest& o) {
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcGetShardingPolicyVersionResponse& o) {
        ar >> o.version;
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcHasShardingPolicyRequest& o) {
        return ar;
    }
    ...
    friend inline rrr::BinaryReadArchive& operator >>(rrr::BinaryReadArchive& ar, RpcHasShardingPolicyResponse& o) {
        ar >> o.has_policy;
        return ar;
    }

    enum {
        GETCONFIG = 0x3b7820d8,
        GETCONFIGVERSION = 0x51bef2f8,
        HASCONFIG = 0x604d966c,
        SETSHARDINGPOLICY = 0x2204aabc,
        GETSHARDINGPOLICY = 0x25068e31,
        GETSHARDINGPOLICYVERSION = 0x6fefc069,
        HASSHARDINGPOLICY = 0x63d6fe5b,
    };
    // Registers RPC IDs with server using service index
    // @unsafe - calls rrr::Server::reg_rpc / unreg (not borrow-checked)
    int __reg_to__(rrr::Server& svr, size_t svc_index) {
