...
void serialize(const mdb::Value &value, BinaryWriteArchive &ar) {
  srpc::Serialize_::serialize(value.ver_, ar);
  switch (value.get_kind()) {
    case mdb::Value::I32:
      srpc::Serialize_::serialize(static_cast<i32>(0), ar);
      srpc::Serialize_::serialize(value.get_i32(), ar);
      break;
    case mdb::Value::I64:
      srpc::Serialize_::serialize(static_cast<i32>(1), ar);
      srpc::Serialize_::serialize(value.get_i64(), ar);
      break;
    case mdb::Value::DOUBLE:
      srpc::Serialize_::serialize(static_cast<i32>(2), ar);
      srpc::Serialize_::serialize(value.get_double(), ar);
      break;
    case mdb::Value::STR:
      srpc::Serialize_::serialize(static_cast<i32>(3), ar);
      srpc::Serialize_::serialize(value.get_str(), ar);
      break;
    default:
      verify(0);
      break;
...
void deserialize(mdb::Value &value, BinaryReadArchive &ar) {
  srpc::Deserialize_::deserialize(value.ver_, ar);
  i32 k;
  srpc::Deserialize_::deserialize(k, ar);
  switch (k) {
    case 0: {
      int32_t i32_v;
      srpc::Deserialize_::deserialize(i32_v, ar);
      value.set_i32(i32_v);
      break;
    }
    case 1: {
      int64_t i64_v;
      srpc::Deserialize_::deserialize(i64_v, ar);
      value.set_i64(i64_v);
      break;
    }
    case 2: {
      double d;
      srpc::Deserialize_::deserialize(d, ar);
      value.set_double(d);
      break;
    }
    case 3: {
      std::string str;
      srpc::Deserialize_::deserialize(str, ar);
      value.set_str(str);
      break;
    }
  }
