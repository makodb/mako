...
class TpcPrepareCommand
    : public srpc::Serializable<
          srpc::PayloadMember<MakoCommands, TpcPrepareCommand>::KIND> {
 public:
  txnid_t tx_id_ = 0;
  int32_t ret_ = -1;
  Command cmd_{};
...
class TpcCommitCommand
    : public srpc::Serializable<
          srpc::PayloadMember<MakoCommands, TpcCommitCommand>::KIND> {
 public:
  txnid_t tx_id_ = 0;
  int ret_ = -1;
  Command cmd_{};
...
class TpcEmptyCommand
    : public srpc::Serializable<
          srpc::PayloadMember<MakoCommands, TpcEmptyCommand>::KIND> {
 private:
...
class TpcNoopCommand
    : public srpc::Serializable<
          srpc::PayloadMember<MakoCommands, TpcNoopCommand>::KIND> {
 public:
  void save(BinaryWriteArchive&) const {}
  void load(BinaryReadArchive&) {}
};
...
class TpcBatchCommand
    : public srpc::Serializable<
          srpc::PayloadMember<MakoCommands, TpcBatchCommand>::KIND> {
  uint32_t size_ = 0;
public:
