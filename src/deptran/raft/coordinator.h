...
int32_t coordinator_raft_phase_value(int32_t phase, int32_t n_phase);
bool coordinator_raft_phase_is_prepare(int32_t phase);
bool coordinator_raft_phase_is_accept(int32_t phase);
bool coordinator_raft_phase_is_commit(int32_t phase);
uint32_t coordinator_raft_majority_count(uint32_t n_replica);
