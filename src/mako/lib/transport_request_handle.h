 ...
 *   across different transport backends (RPC, rrr/rpc, etc.)
 *
 **********************************************************************/
 ...
 * knowing the underlying transport implementation (RPC, rrr/rpc, etc.)
 */
...
public:
     ...
     * For RPC: No-op (RPC handles response enqueueing automatically)
