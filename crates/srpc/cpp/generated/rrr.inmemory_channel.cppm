...
// srpc-cpp-source: crates/srpc/src/rpc/inmemory_channel.rs
// srpc-cpp-source-sha256: f2ba866d40d2366e4e2dd46fb6add82f120c4b55aad7f4ce49e3e8d496c786dd
...
// srpc-cpp-unit-id: rrr.inmemory_channel.interface
// srpc-cpp-module: rrr.inmemory_channel
...
// srpc-cpp-output-sha256: f0a96a7940d4a97280d22cc85c6d22ac8978a662fce819cca86c5829ae9e8b68
...
rusty::Result<Duration, rusty::Unit> elapsed() const {
...
InMemoryConnectionStateInner empty_connection_inner();
rusty::Arc<InMemoryConnectionState> make_connection_state(std::string a_address, std::string b_address);
...
InMemoryListenerInnerState empty_listener_inner();
...
export struct InMemoryConnectionStateInner {
    ...
    ::rrr::OnFrameCallback a_on_frame;
    ::rrr::OnClosedCallback a_on_closed;
    ::rrr::OnErrorCallback a_on_error;
    bool a_closed;
    std::string b_peer_address;
    ::rrr::OnFrameCallback b_on_frame;
    ::rrr::OnClosedCallback b_on_closed;
    ::rrr::OnErrorCallback b_on_error;
    bool b_closed;
    int32_t drop_next_sends_a;
    int32_t drop_next_sends_b;
    int32_t send_error_count_a;
    int32_t send_error_count_b;
    ::rrr::ChannelError send_error_a;
    ::rrr::ChannelError send_error_b;
};
...
export struct InMemoryChannel {
    ...
    void set_on_frame(::rrr::OnFrameCallback callback) const;
    void set_on_closed(::rrr::OnClosedCallback callback) const;
    void set_on_error(::rrr::OnErrorCallback callback) const;
};

/// Arc-retaining adapter for the channel facade's owning proxy.
export struct InMemoryChannelShim : public ChannelConnectionBase {
    ...
    bool is_closed() const;
    std::string peer_address() const;
    void set_on_frame(::rrr::OnFrameCallback callback);
    void set_on_closed(::rrr::OnClosedCallback callback);
    void set_on_error(::rrr::OnErrorCallback callback);
};
...
export struct InMemoryListenerInnerState {
    ...
    bool closed;
    ::rrr::OnAcceptCallback on_accept;
    ::rrr::OnErrorCallback on_error;
};
...
export struct InMemorySwitchboard {
    ...
    bool register_listener(std::string address, rusty::sync::Weak<InMemoryListener> listener) const;
    void unregister_listener(const std::string& address) const;
    rusty::Option<rusty::Arc<InMemoryListener>> find_listener(const std::string& address) const;
};
...
export struct InMemoryListener {
    ...
    ::rrr::ChannelError listen(std::string_view address) const;
    void close() const;
    bool is_closed() const;
    std::string local_address() const;
    void set_on_accept(::rrr::OnAcceptCallback callback) const;
    void set_on_error(::rrr::OnErrorCallback callback) const;
    void set_self_weak(rusty::sync::Weak<InMemoryListener> weak);
};

/// Arc-retaining adapter for the listener facade's owning proxy.
export struct InMemoryListenerShim : public ChannelListenerBase {
    ...
    ::rrr::ChannelError listen(std::string_view address);
    void close();
    bool is_closed() const;
    std::string local_address() const;
    void set_on_accept(::rrr::OnAcceptCallback callback);
    void set_on_error(::rrr::OnErrorCallback callback);
};
...
export struct InMemoryFactory {
    ...
    ::rrr::ConnectResult connect(std::string_view address) const;
    rusty::Option<::rrr::ChannelListenerProxy> make_listener() const;
};

/// Arc-retaining adapter for the factory facade's owning proxy.
export struct InMemoryFactoryShim : public ChannelFactoryBase {
    ...
    ::rrr::ConnectResult connect(std::string_view address);
    rusty::Option<::rrr::ChannelListenerProxy> make_listener();
    std::string backend_name() const;
};

::rrr::ChannelError channel_error_from_code(int32_t code) {
    // @unsafe
    {
        return rusty::mem::transmute<std::remove_cvref_t<decltype((std::move(code)))>, ::rrr::ChannelError>(std::move(code));
    }
}

::rrr::ChannelError channel_error_none() {
    return ::rrr::channel_error_from_code(static_cast<int32_t>(0));
}

::rrr::ChannelError channel_error_connection_reset() {
    return ::rrr::channel_error_from_code(static_cast<int32_t>(3));
}

::rrr::ChannelError channel_error_address_in_use() {
    return ::rrr::channel_error_from_code(static_cast<int32_t>(5));
}

::rrr::ChannelError channel_error_internal() {
    return ::rrr::channel_error_from_code(static_cast<int32_t>(9));
}

InMemoryConnectionStateInner empty_connection_inner() {
    return InMemoryConnectionStateInner{.a_peer_address = std::format(""), .a_on_frame = ::rrr::OnFrameCallback::default_(), .a_on_closed = ::rrr::OnClosedCallback::default_(), .a_on_error = ::rrr::OnErrorCallback::default_(), .a_closed = false, .b_peer_address = std::format(""), .b_on_frame = ::rrr::OnFrameCallback::default_(), .b_on_closed = ::rrr::OnClosedCallback::default_(), .b_on_error = ::rrr::OnErrorCallback::default_(), .b_closed = false, .drop_next_sends_a = static_cast<int32_t>(0), .drop_next_sends_b = static_cast<int32_t>(0), .send_error_count_a = static_cast<int32_t>(0), .send_error_count_b = static_cast<int32_t>(0), .send_error_a = ::rrr::channel_error_none(), .send_error_b = ::rrr::channel_error_none()};
}

rusty::Arc<InMemoryConnectionState> make_connection_state(std::string a_address, std::string b_address) {
    InMemoryConnectionStateInner inner = ::rrr::empty_connection_inner();
    inner.a_peer_address = std::move(a_address);
    inner.b_peer_address = std::move(b_address);
    return rusty::Arc<InMemoryConnectionState>::make(InMemoryConnectionState{.inner = rusty::Mutex<InMemoryConnectionStateInner>::new_(std::move(inner))});
}
...
export ::rrr::ChannelError inmemory_channel_send_frame(const InMemoryChannel& channel, const ::rrr::ChannelFrame& frame) {
    std::optional<::rrr::OnFrameCallback> peer_on_frame;
    std::optional<bool> self_already_closed;
    std::optional<bool> peer_already_closed;
    bool drop_this_send = false;
    bool inject_error = false;
    ::rrr::ChannelError injected_error = ::rrr::channel_error_none();
    {
        auto guard = (*channel.state_).inner.lock().unwrap();
        if (channel.is_a_side_) {
            self_already_closed.emplace(std::move((*guard).a_closed));
            peer_already_closed.emplace(std::move((*guard).b_closed));
            peer_on_frame.emplace(rusty::clone((*guard).b_on_frame));
            if (rusty::detail::deref_if_pointer_like((*guard).drop_next_sends_a) > static_cast<int32_t>(0)) {
                drop_this_send = true;
                (*guard).drop_next_sends_a -= static_cast<int32_t>(1);
            } else if (rusty::detail::deref_if_pointer_like((*guard).send_error_count_a) > static_cast<int32_t>(0)) {
                inject_error = true;
                injected_error = std::move((*guard).send_error_a);
                (*guard).send_error_count_a -= static_cast<int32_t>(1);
            }
        } else {
            self_already_closed.emplace(std::move((*guard).b_closed));
            peer_already_closed.emplace(std::move((*guard).a_closed));
            peer_on_frame.emplace(rusty::clone((*guard).a_on_frame));
            if (rusty::detail::deref_if_pointer_like((*guard).drop_next_sends_b) > static_cast<int32_t>(0)) {
                drop_this_send = true;
                (*guard).drop_next_sends_b -= static_cast<int32_t>(1);
            } else if (rusty::detail::deref_if_pointer_like((*guard).send_error_count_b) > static_cast<int32_t>(0)) {
                inject_error = true;
                injected_error = std::move((*guard).send_error_b);
                (*guard).send_error_count_b -= static_cast<int32_t>(1);
            }
        }
    }
    if (rusty::detail::deref_if_pointer_like(self_already_closed.value()) || rusty::detail::deref_if_pointer_like(peer_already_closed.value())) {
        return ::rrr::channel_error_connection_reset();
    }
    if (drop_this_send) {
        return ::rrr::channel_error_none();
    }
    if (inject_error) {
        return std::move(injected_error);
    }
    rusty::Vec<uint8_t> bytes = rusty::Vec<uint8_t>::new_();
    if ((rusty::detail::deref_if_pointer_like(frame.size) > static_cast<size_t>(0)) && rusty::detail::rust_not((frame.payload == nullptr))) {
        const std::span<const uint8_t> payload = rusty::from_raw_parts(frame.payload, frame.size);
        bytes.extend_from_slice(payload);
    }
    const ::rrr::ChannelFrame delivered = ::rrr::ChannelFrame{.payload = rusty::as_ptr(bytes), .size = rusty::len(bytes)};
    if (peer_on_frame.value().has_value()) {
        (peer_on_frame.value().callable())(delivered);
    }
    return ::rrr::channel_error_none();
}
...
export void inmemory_channel_inject_drop_next_sends(const InMemoryChannel& channel, int32_t count) {
    auto guard = (*channel.state_).inner.lock().unwrap();
    if (channel.is_a_side_) {
        (*guard).drop_next_sends_a = std::move(count);
    } else {
        (*guard).drop_next_sends_b = std::move(count);
    }
}
...
export void inmemory_channel_inject_send_error(const InMemoryChannel& channel, ::rrr::ChannelError error, int32_t count) {
    auto guard = (*channel.state_).inner.lock().unwrap();
    if (channel.is_a_side_) {
        (*guard).send_error_a = std::move(error);
        (*guard).send_error_count_a = std::move(count);
    } else {
        (*guard).send_error_b = std::move(error);
        (*guard).send_error_count_b = std::move(count);
    }
}
...
export void inmemory_channel_clear_fault_injection(const InMemoryChannel& channel) {
    auto guard = (*channel.state_).inner.lock().unwrap();
    if (channel.is_a_side_) {
        (*guard).drop_next_sends_a = static_cast<int32_t>(0);
        (*guard).send_error_count_a = static_cast<int32_t>(0);
        (*guard).send_error_a = ::rrr::channel_error_none();
    } else {
        (*guard).drop_next_sends_b = static_cast<int32_t>(0);
        (*guard).send_error_count_b = static_cast<int32_t>(0);
        (*guard).send_error_b = ::rrr::channel_error_none();
    }
}

export ::rrr::ChannelConnectionProxy make_inmemory_channel_proxy(rusty::Arc<InMemoryChannel> connection) {
    return rusty::Box<InMemoryChannelShim>::new_(InMemoryChannelShim(std::move(connection)));
}

InMemoryListenerInnerState empty_listener_inner() {
    return InMemoryListenerInnerState{.local_address = std::format(""), .closed = false, .on_accept = ::rrr::OnAcceptCallback::default_(), .on_error = ::rrr::OnErrorCallback::default_()};
}

::rrr::ChannelError inmemory_listener_listen_with_weak(const InMemoryListener& listener, std::string_view address, rusty::Option<rusty::sync::Weak<InMemoryListener>> self_weak) {
    std::optional<rusty::sync::Weak<InMemoryListener>> weak;
    {
        auto guard = listener.inner_.lock().unwrap();
        if ((*guard).closed) {
            return ::rrr::channel_error_internal();
        }
        if (rusty::detail::rust_not(rusty::is_empty((*guard).local_address))) {
            if ((*guard).local_address == rusty::detail::deref_if_pointer_like(address)) {
                return ::rrr::channel_error_none();
            }
            return ::rrr::channel_error_address_in_use();
        }
        if (self_weak.is_none()) {
            return ::rrr::channel_error_internal();
        }
        weak.emplace(self_weak.unwrap());
        (*guard).local_address = std::format("{}" , address);
    }
    if (rusty::detail::rust_not(listener.switchboard_->register_listener(std::format("{}" , address), std::move(weak.value())))) {
        auto guard = listener.inner_.lock().unwrap();
...
export rusty::Option<rusty::Arc<InMemoryChannel>> inmemory_listener_accept_for_connect(const InMemoryListener& listener, const std::string& client_address) {
    std::optional<::rrr::OnAcceptCallback> callback;
    std::optional<std::string> server_address;
    {
        auto guard = listener.inner_.lock().unwrap();
        if (rusty::detail::deref_if_pointer_like((*guard).closed) || rusty::is_empty((*guard).local_address)) {
            return rusty::Option<rusty::Arc<InMemoryChannel>>{rusty::None};
        }
        callback.emplace(rusty::clone((*guard).on_accept));
        server_address.emplace(rusty::clone((*guard).local_address));
    }
    if (rusty::detail::rust_not(callback.value().has_value())) {
        return rusty::Option<rusty::Arc<InMemoryChannel>>{rusty::None};
    }
    const rusty::Arc<InMemoryConnectionState> state = ::rrr::make_connection_state(rusty::clone(client_address), std::move(server_address.value()));
    rusty::Arc<InMemoryChannel> client_side = rusty::Arc<InMemoryChannel>::make(InMemoryChannel::new_(rusty::clone(state), true));
    rusty::Arc<InMemoryChannel> server_side = rusty::Arc<InMemoryChannel>::make(InMemoryChannel::new_(rusty::clone(state), false));
    (callback.value().callable())(::rrr::make_inmemory_channel_proxy(std::move(server_side)));
...
export ::rrr::ChannelListenerProxy make_inmemory_listener_proxy(rusty::Arc<InMemoryListener> listener) {
    return rusty::Box<InMemoryListenerShim>::new_(InMemoryListenerShim(std::move(listener)));
}

export ::rrr::ConnectResult inmemory_factory_connect(const InMemoryFactory& factory, std::string_view address) {
    const std::string address_string = std::format("{}" , address);
    rusty::Option<rusty::Arc<InMemoryListener>> listener_option = factory.switchboard_->find_listener(address_string);
    if (listener_option.is_none()) {
        return ::rrr::ConnectResult{.connection = rusty::None, .error = ::rrr::ChannelError::ConnectionRefused};
    }
    const rusty::Arc<InMemoryListener> listener = listener_option.unwrap();
    static rusty::sync::atomic::AtomicU64 CLIENT_COUNTER = AtomicU64::new_(static_cast<uint64_t>(0));
    ...
    rusty::Option<rusty::Arc<InMemoryChannel>> client_side_option = ::rrr::inmemory_listener_accept_for_connect(rusty::detail::deref_if_pointer_like(listener), client_address);
    if (client_side_option.is_none()) {
        return ::rrr::ConnectResult{.connection = rusty::None, .error = ::rrr::ChannelError::ConnectionRefused};
    }
    rusty::Arc<InMemoryChannel> client_side = client_side_option.unwrap();
    return ::rrr::ConnectResult{.connection = rusty::Option<::rrr::ChannelConnectionProxy>(::rrr::make_inmemory_channel_proxy(std::move(client_side))), .error = ::rrr::ChannelError::None};
}

export rusty::Option<::rrr::ChannelListenerProxy> inmemory_factory_make_listener(const InMemoryFactory& factory) {
    rusty::Arc<InMemoryListener> listener = rusty::Arc<InMemoryListener>::make(InMemoryListener::new_(rusty::clone(factory.switchboard_)));
    return rusty::Option<::rrr::ChannelListenerProxy>(::rrr::make_inmemory_listener_proxy(std::move(listener)));
}

export ::rrr::ChannelFactoryProxy make_inmemory_factory_proxy(rusty::Arc<InMemoryFactory> factory) {
    return rusty::Box<InMemoryFactoryShim>::new_(InMemoryFactoryShim(std::move(factory)));
}

/// Build a raw pair for fault-injection tests without a listener/factory.
export std::tuple<rusty::Arc<InMemoryChannel>, rusty::Arc<InMemoryChannel>> make_channel_pair_for_testing(std::string a_address, std::string b_address) {
    const rusty::Arc<InMemoryConnectionState> state = ::rrr::make_connection_state(std::move(a_address), std::move(b_address));
    rusty::Arc<InMemoryChannel> a_side = rusty::Arc<InMemoryChannel>::make(InMemoryChannel::new_(rusty::clone(state), true));
    rusty::Arc<InMemoryChannel> b_side = rusty::Arc<InMemoryChannel>::make(InMemoryChannel::new_(rusty::clone(state), false));
...
::rrr::ChannelError InMemoryChannel::send_frame(const ::rrr::ChannelFrame& frame) const {
    return ::rrr::inmemory_channel_send_frame((*this), frame);
}
...
void InMemoryChannel::close() const {
    ::rrr::OnClosedCallback peer_on_closed = ::rrr::OnClosedCallback::default_();
    bool fire_peer_closed = false;
    {
        ...
        if (this->is_a_side_) {
            ...
            (*guard).a_closed = true;
            if (!(*guard).b_closed) {
                peer_on_closed = rusty::clone((*guard).b_on_closed);
            ...
            (*guard).b_closed = true;
            if (!(*guard).a_closed) {
                peer_on_closed = rusty::clone((*guard).a_on_closed);
                fire_peer_closed = true;
            }
        }
    }
    if (rusty::detail::deref_if_pointer_like(fire_peer_closed) && peer_on_closed.has_value()) {
        (peer_on_closed.callable())(::rrr::ChannelError::None);
    }
}

bool InMemoryChannel::is_closed() const {
    auto guard = (*this->state_).inner.lock().unwrap();
    return rusty::detail::deref_if_pointer_like((*guard).a_closed) || rusty::detail::deref_if_pointer_like((*guard).b_closed);
}

std::string InMemoryChannel::peer_address() const {
    auto guard = (*this->state_).inner.lock().unwrap();
    if (this->is_a_side_) {
        return rusty::clone((*guard).b_peer_address);
    } else {
        return rusty::clone((*guard).a_peer_address);
    }
}

void InMemoryChannel::set_on_frame(::rrr::OnFrameCallback callback) const {
    auto guard = (*this->state_).inner.lock().unwrap();
    if (this->is_a_side_) {
        (*guard).a_on_frame = std::move(callback);
    } else {
        (*guard).b_on_frame = std::move(callback);
    }
}

void InMemoryChannel::set_on_closed(::rrr::OnClosedCallback callback) const {
    auto guard = (*this->state_).inner.lock().unwrap();
    if (this->is_a_side_) {
        (*guard).a_on_closed = std::move(callback);
    } else {
        (*guard).b_on_closed = std::move(callback);
    }
}

void InMemoryChannel::set_on_error(::rrr::OnErrorCallback callback) const {
    auto guard = (*this->state_).inner.lock().unwrap();
    if (this->is_a_side_) {
        (*guard).a_on_error = std::move(callback);
    } else {
        (*guard).b_on_error = std::move(callback);
    }
}

::rrr::ChannelError InMemoryChannelShim::send_frame(const ::rrr::ChannelFrame& frame) {
    return rusty::detail::deref_if_pointer_like(this->conn_).send_frame(frame);
}

void InMemoryChannelShim::flush() {
    rusty::detail::deref_if_pointer_like(this->conn_).flush();
}

void InMemoryChannelShim::close() {
    rusty::detail::deref_if_pointer_like(this->conn_).close();
}

bool InMemoryChannelShim::is_closed() const {
    return rusty::detail::deref_if_pointer_like(this->conn_).is_closed();
}

std::string InMemoryChannelShim::peer_address() const {
    return rusty::detail::deref_if_pointer_like(this->conn_).peer_address();
}

void InMemoryChannelShim::set_on_frame(::rrr::OnFrameCallback callback) {
    rusty::detail::deref_if_pointer_like(this->conn_).set_on_frame(std::move(callback));
}

void InMemoryChannelShim::set_on_closed(::rrr::OnClosedCallback callback) {
    rusty::detail::deref_if_pointer_like(this->conn_).set_on_closed(std::move(callback));
}

void InMemoryChannelShim::set_on_error(::rrr::OnErrorCallback callback) {
    rusty::detail::deref_if_pointer_like(this->conn_).set_on_error(std::move(callback));
}
...
bool InMemorySwitchboard::register_listener(std::string address, rusty::sync::Weak<InMemoryListener> listener) const {
    auto guard = this->listeners_.lock().unwrap();
    if ((*guard).contains_key(address)) {
        return false;
    }
    (*guard).insert(std::move(address), std::move(listener));
    return true;
}

void InMemorySwitchboard::unregister_listener(const std::string& address) const {
    auto guard = this->listeners_.lock().unwrap();
    (*guard).remove(address);
}

rusty::Option<rusty::Arc<InMemoryListener>> InMemorySwitchboard::find_listener(const std::string& address) const {
    auto guard = this->listeners_.lock().unwrap();
    rusty::Option<rusty::Arc<InMemoryListener>> upgraded = ({ auto&& _m = guard->get(address); std::optional<rusty::Option<rusty::Arc<InMemoryListener>>> _match_value; if (_m.is_some()) { auto&& _mv = _m.unwrap();
auto&& listener = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(listener.upgrade())); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable_panic(); } return rusty::Option<rusty::Arc<InMemoryListener>>{rusty::None}; } ([&](auto&& __v) -> decltype(auto) { using __MatchValueT = std::remove_cvref_t<decltype(__v)>; if constexpr (requires { typename __MatchValueT::type; }) { if constexpr (std::is_same_v<__MatchValueT, std::reference_wrapper<typename __MatchValueT::type>>) { return std::forward<decltype(__v)>(__v).get(); } else { return std::forward<decltype(__v)>(__v); } } else { return std::forward<decltype(__v)>(__v); } })(std::move(_match_value).value()); });
    if (upgraded.is_none()) {
        (*guard).remove(address);
    }
...
InMemoryListener InMemoryListener::new_(rusty::Arc<InMemorySwitchboard> switchboard) {
    return InMemoryListener{.switchboard_ = std::move(switchboard), .self_weak_ = rusty::Option<rusty::sync::Weak<InMemoryListener>>{rusty::None}, .inner_ = rusty::Mutex<InMemoryListenerInnerState>::new_(::rrr::empty_listener_inner())};
}

::rrr::ChannelError InMemoryListener::listen(std::string_view address) const {
    return ::rrr::inmemory_listener_listen_with_weak((*this), rusty::to_string_view(address), rusty::clone(this->self_weak_));
}
...
void InMemoryListener::close() const {
    ...
    (*guard).closed = true;
    const std::string address_to_unregister = rusty::clone((*guard).local_address);
    rusty::mem::drop(std::move(guard));
    if (rusty::detail::rust_not(rusty::is_empty(address_to_unregister))) {
        auto switchboard_guard = (*this->switchboard_).listeners_.lock().unwrap();
...
bool InMemoryListener::is_closed() const {
    auto guard = this->inner_.lock().unwrap();
    return std::move((*guard).closed);
}

std::string InMemoryListener::local_address() const {
    auto guard = this->inner_.lock().unwrap();
    return rusty::clone((*guard).local_address);
}

void InMemoryListener::set_on_accept(::rrr::OnAcceptCallback callback) const {
    auto guard = this->inner_.lock().unwrap();
    (*guard).on_accept = std::move(callback);
}

void InMemoryListener::set_on_error(::rrr::OnErrorCallback callback) const {
    auto guard = this->inner_.lock().unwrap();
    (*guard).on_error = std::move(callback);
}

void InMemoryListener::set_self_weak(rusty::sync::Weak<InMemoryListener> weak) {
    this->self_weak_ = rusty::Option<rusty::sync::Weak<InMemoryListener>>(std::move(weak));
}

::rrr::ChannelError InMemoryListenerShim::listen(std::string_view address) {
    rusty::sync::Weak<InMemoryListener> self_weak = rusty::sync::downgrade(this->listener_);
    return ::rrr::inmemory_listener_listen_with_weak(rusty::detail::deref_if_pointer_like(this->listener_), rusty::to_string_view(address), rusty::Option<rusty::sync::Weak<InMemoryListener>>(std::move(self_weak)));
}

void InMemoryListenerShim::close() {
    rusty::detail::deref_if_pointer_like(this->listener_).close();
}

bool InMemoryListenerShim::is_closed() const {
    return rusty::detail::deref_if_pointer_like(this->listener_).is_closed();
}

std::string InMemoryListenerShim::local_address() const {
    return rusty::detail::deref_if_pointer_like(this->listener_).local_address();
}

void InMemoryListenerShim::set_on_accept(::rrr::OnAcceptCallback callback) {
    rusty::detail::deref_if_pointer_like(this->listener_).set_on_accept(std::move(callback));
}

void InMemoryListenerShim::set_on_error(::rrr::OnErrorCallback callback) {
    rusty::detail::deref_if_pointer_like(this->listener_).set_on_error(std::move(callback));
}
...
std::string InMemoryFactory::backend_name() const {
    return std::format("inmemory");
}

::rrr::ConnectResult InMemoryFactory::connect(std::string_view address) const {
    return ::rrr::inmemory_factory_connect((*this), rusty::to_string_view(address));
}

rusty::Option<::rrr::ChannelListenerProxy> InMemoryFactory::make_listener() const {
    return ::rrr::inmemory_factory_make_listener((*this));
}

::rrr::ConnectResult InMemoryFactoryShim::connect(std::string_view address) {
    return rusty::detail::deref_if_pointer_like(this->factory_).connect(address);
}

rusty::Option<::rrr::ChannelListenerProxy> InMemoryFactoryShim::make_listener() {
    return rusty::detail::deref_if_pointer_like(this->factory_).make_listener();
}

std::string InMemoryFactoryShim::backend_name() const {
    return rusty::detail::deref_if_pointer_like(this->factory_).backend_name();
}
