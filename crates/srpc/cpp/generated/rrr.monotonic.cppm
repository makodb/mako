...
// srpc-cpp-source: crates/srpc/src/base/monotonic.rs
// srpc-cpp-source-sha256: 45614297209708d3b615fe2e72ed6da6379ef2470854490a67164297222d7e37
...
// srpc-cpp-unit-id: rrr.monotonic.interface
// srpc-cpp-module: rrr.monotonic
...
// srpc-cpp-output-sha256: bc762b52184c52f8312ab306a908951c36d837a11a8f3403da1e9e97a6862a05
...
export module rrr.monotonic;

namespace rrr {

constexpr uint64_t NONZERO_EPOCH_US = static_cast<uint64_t>(1) << 56;
extern rusty::Mutex<rusty::Option<rusty::time::Instant>> MONOTONIC_EPOCH;
export uint64_t monotonic_time_us();

using rusty::Mutex;

using rusty::time::Instant;


inline rusty::Mutex<rusty::Option<rusty::time::Instant>> MONOTONIC_EPOCH = rusty::Mutex<rusty::Option<rusty::time::Instant>>::new_(rusty::Option<rusty::time::Instant>{rusty::None});

export uint64_t monotonic_time_us() {
    auto epoch = MONOTONIC_EPOCH.lock().unwrap();
    return rusty::detail::deref_if_pointer_like(NONZERO_EPOCH_US) + (static_cast<uint64_t>((*epoch).get_or_insert_with(Instant::now).elapsed().as_micros()));
}
