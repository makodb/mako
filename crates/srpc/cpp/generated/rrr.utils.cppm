...
// srpc-cpp-source: crates/srpc/src/rpc/utils.rs
// srpc-cpp-source-sha256: e86e3e7cdf6644210f994193ceea46bec5b8aa06acde07e45ef7ffadd36f9553
...
// srpc-cpp-unit-id: rrr.utils.interface
// srpc-cpp-module: rrr.utils
// srpc-cpp-unit-kind: interface
// srpc-cpp-type-map-sha256: 06bc93f92e3d5b7f35ddc2db45391e86776d7264de8d7405a48b18d5449843b7
// srpc-cpp-legacy-dependencies-sha256: 37517e5f3dc66819f61f5a7bb8ace1921282415f10551d2defa5c3eb0985b570
// srpc-cpp-cpp-module-index-source-sha256: 6449a627fe5bd7c5449f4b4f2dfe3dc30e66a06c0c6a9086a03353181203a5fc
// srpc-cpp-cpp-module-index-sha256: 2d4d6158e59b5edec570f8bf1c4ff541618d02d6aba2d4e6bdc5dba2d8af9b09
// srpc-cpp-output-sha256: a1be0ebc457d62876e02cdc4a9c8c7a702046719032ff48c5de87fca438a3fdf
...
using LegacyAddrInfo = rusty::ffi::c_void;
...
namespace utils_ffi {
    ...
    using ::rrr::LegacyAddrInfo;

    extern "C" {
        void freeaddrinfo(addrinfo* info);
        int32_t srpc_find_open_port();
    }
...
export int32_t find_open_port() {
    int32_t port = utils_ffi::srpc_find_open_port();
    if (rusty::detail::deref_if_pointer_like(port) > static_cast<int32_t>(0)) {
        const std::string message = std::format("Found open port: {}" , port);
        log_line(rusty::clone(rusty::clone(::rrr::Log::INFO)), static_cast<int32_t>(0), rusty::ptr::null<int8_t>(), message);
        return std::move(port);
    }
    const std::string message = rusty::to_string("Failed to find open port.");
    log_line(rusty::clone(rusty::clone(::rrr::Log::ERROR)), static_cast<int32_t>(0), rusty::ptr::null<int8_t>(), message);
...
export std::string get_host_name() {
    ...
    if (rusty::is_empty(name)) {
        const std::string message = rusty::to_string("Failed to get hostname.");
        log_line(rusty::clone(rusty::clone(::rrr::Log::ERROR)), static_cast<int32_t>(0), rusty::ptr::null<int8_t>(), message);
    }
