...
// srpc-cpp-source: crates/srpc/src/base/legacy_threading.rs
// srpc-cpp-source-sha256: 30e18d3044fc56520ec79622294e2fe07e57fa7dc55a6a9a13e154fa1abea106
...
// srpc-cpp-unit-id: rrr.threading.interface
// srpc-cpp-module: rrr.threading
// srpc-cpp-unit-kind: interface
// srpc-cpp-type-map-sha256: f76e84c368fa1adbb24566cc1c51859c5e7c4de632aaf72252bb096d15b4faf3
// srpc-cpp-legacy-dependencies-sha256: f202a40f8e4d0bdfc79ff4740ad6c5bd0b671f6b964498eefe5ace4f36b1c67e
// srpc-cpp-cpp-module-index-source-sha256: 5b5de0afc47e14f3bf6ca4f8fd168809026235fcb803f8781017190919341c55
// srpc-cpp-cpp-module-index-sha256: 506cb3cf3b9a95fa1f6730297336f3e8414aa243e8e7bc7fbd877dbea305284d
// srpc-cpp-output-sha256: 04233180aa0c768d4de043490272a0350db7e160b75206c50c7edfd2a8a9c782
...
using LegacyPthreadSpinlock = rusty::ffi::c_void;
using LegacyPthreadMutex = rusty::ffi::c_void;
using LegacyPthreadMutexAttr = rusty::ffi::c_void;
using LegacyPthreadCond = rusty::ffi::c_void;
using LegacyPthreadCondAttr = rusty::ffi::c_void;
namespace threading_ffi {
}
export void Pthread_spin_init(pthread_spinlock_t* lock, int32_t pshared);
export void Pthread_spin_lock(pthread_spinlock_t* lock);
export void Pthread_spin_unlock(pthread_spinlock_t* lock);
export void Pthread_spin_destroy(pthread_spinlock_t* lock);
export void Pthread_mutex_init(pthread_mutex_t* mutex, const pthread_mutexattr_t* attr);
export void Pthread_mutex_lock(pthread_mutex_t* mutex);
export void Pthread_mutex_unlock(pthread_mutex_t* mutex);
export void Pthread_mutex_destroy(pthread_mutex_t* mutex);
export void Pthread_cond_init(pthread_cond_t* cond, const pthread_condattr_t* attr);
export void Pthread_cond_destroy(pthread_cond_t* cond);
export void Pthread_cond_signal(pthread_cond_t* cond);
export void Pthread_cond_broadcast(pthread_cond_t* cond);
export void Pthread_cond_wait(pthread_cond_t* cond, pthread_mutex_t* mutex);
...
export using rusty::sync::atomic::AtomicBool;
...
namespace threading_ffi {
    ...
    using ::rrr::LegacyPthreadCond;
    using ::rrr::LegacyPthreadCondAttr;
    using ::rrr::LegacyPthreadMutex;
    using ::rrr::LegacyPthreadMutexAttr;
    using ::rrr::LegacyPthreadSpinlock;

    extern "C" {
        int32_t pthread_spin_init(pthread_spinlock_t* lock, int32_t pshared);
        int32_t pthread_spin_lock(pthread_spinlock_t* lock);
        int32_t pthread_spin_unlock(pthread_spinlock_t* lock);
        int32_t pthread_spin_destroy(pthread_spinlock_t* lock);
        int32_t pthread_mutex_init(pthread_mutex_t* mutex, const pthread_mutexattr_t* attr);
        ...
        int32_t pthread_cond_init(pthread_cond_t* cond, const pthread_condattr_t* attr);
...
export void Pthread_spin_init(pthread_spinlock_t* lock, int32_t pshared) {
    const auto status = threading_ffi::pthread_spin_init(lock, std::move(pshared));
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
}

/// Acquire a caller-owned pthread spin lock and verify libc's status.
export void Pthread_spin_lock(pthread_spinlock_t* lock) {
    const auto status = threading_ffi::pthread_spin_lock(lock);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
...
export void Pthread_spin_unlock(pthread_spinlock_t* lock) {
    const auto status = threading_ffi::pthread_spin_unlock(lock);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
...
export void Pthread_spin_destroy(pthread_spinlock_t* lock) {
    const auto status = threading_ffi::pthread_spin_destroy(lock);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
...
export void Pthread_mutex_init(pthread_mutex_t* mutex, const pthread_mutexattr_t* attr) {
    const auto status = threading_ffi::pthread_mutex_init(mutex, attr);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
...
export void Pthread_mutex_lock(pthread_mutex_t* mutex) {
    const auto status = threading_ffi::pthread_mutex_lock(mutex);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
...
export void Pthread_mutex_unlock(pthread_mutex_t* mutex) {
    const auto status = threading_ffi::pthread_mutex_unlock(mutex);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
...
export void Pthread_mutex_destroy(pthread_mutex_t* mutex) {
    const auto status = threading_ffi::pthread_mutex_destroy(mutex);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
...
export void Pthread_cond_init(pthread_cond_t* cond, const pthread_condattr_t* attr) {
    const auto status = threading_ffi::pthread_cond_init(cond, attr);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
...
export void Pthread_cond_destroy(pthread_cond_t* cond) {
    const auto status = threading_ffi::pthread_cond_destroy(cond);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
...
export void Pthread_cond_signal(pthread_cond_t* cond) {
    const auto status = threading_ffi::pthread_cond_signal(cond);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
...
export void Pthread_cond_broadcast(pthread_cond_t* cond) {
    const auto status = threading_ffi::pthread_cond_broadcast(cond);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
...
export void Pthread_cond_wait(pthread_cond_t* cond, pthread_mutex_t* mutex) {
    const auto status = threading_ffi::pthread_cond_wait(cond, mutex);
    // @unsafe
    {
        ::rrr::verify((rusty::detail::deref_if_pointer_like(status) == static_cast<int32_t>(0)));
    }
