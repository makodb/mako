...
if(NOT _actual_count EQUAL 34)
    message(FATAL_ERROR
        "Masstree ABI must export exactly 34 mt_* symbols, found ${_actual_count}")
endif()
message(STATUS
    "Masstree ABI exports exactly the 34 allowlisted mt_* symbols")
