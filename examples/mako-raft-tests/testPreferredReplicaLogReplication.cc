...
// =============================================================================
rusty::Arc<TpcCommitCommand> create_log_command(const char* log_data, int length, txnid_t tx_id) {
...
// =============================================================================
string serialize_tpc_command(const rusty::Arc<TpcCommitCommand>& cmd) {
